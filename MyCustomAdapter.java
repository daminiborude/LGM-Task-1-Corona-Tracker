...
public class MyCustomAdapter  extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter(Context context, List<CountryModel> countryModelsList) {
        super(context,R.layout.list_design,countryModelsList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_design,null,true);
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                InfectedCountry.countryModelsList = (List<CountryModel>) results.values;
