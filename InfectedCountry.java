...
public class InfectedCountry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infected_country);
    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            myCustomAdapter = new MyCustomAdapter(InfectedCountry.this,countryModelsList);
            ...
            public void onErrorResponse(VolleyError error) {
                simpleArcLoader.stop();
                simpleArcLoader.setVisibility(View.GONE);
                Toast.makeText(InfectedCountry.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
